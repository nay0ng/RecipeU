...
1. NOT_COOKING (음식/요리 무관 또는 개인정보 포함)
   ...
   **중요: 식품 안전/유통기한/보관 상태 질문 → NOT_COOKING (레시피 요청 아님)**
   예: "베이컨 산 지 2주 됐는데 괜찮아?", "이 재료 상한 거 아니야?", "유통기한 지났는데 먹어도 돼?"
...
2. RECIPE_MODIFY (레시피=Y + 재료 수정/제거)
   ...
   **중요: "[재료] 싫어해", "[재료] 안먹어" → RECIPE_MODIFY (레시피=Y일 때)**
   예: "파 싫어해", "고수 안먹어", "버섯 싫어"
